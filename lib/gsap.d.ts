...
// Definitions: https://github.com/DefinitelyTyped/DefinitelyTyped
    declare class GsapAnimation {
        ...
        delay(): number;
        delay(value: number): GsapAnimation;
        ...
        duration(): number;
        duration(value: number): GsapAnimation;
        ...
        eventCallback(type: string, callback: (...args: any[]) => void, params?: any[], scope?: any): GsapAnimation;
        ...
        kill(vars?: {}, target?: {}): GsapAnimation;

        /** Pauses the instance, optionally jumping to a specific time. */
        pause(atTime?: any, suppressEvents?: boolean): GsapAnimation;

        /** Gets or sets the animation's paused state which indicates whether or not the animation is currently paused. */
        paused(): boolean;
        paused(value: boolean): GsapAnimation;
        ...
        play(from?: any, suppressEvents?: boolean): GsapAnimation;
        ...
        totalDuration(value: number): GsapAnimation;
        ...
        totalProgress(value: number, suppressEvents?: boolean): GsapAnimation;
        ...
        totalTime(): number;
        totalTime(time: number, suppressEvents?: boolean): GsapAnimation;
    }
    ...
    declare class SimpleTimeline extends GsapAnimation {
        /**
    ...
    declare class TimelineMax extends TimelineLite {
        ...
        restart(includeDelay?: boolean, suppressEvents?: boolean): TimelineMax;
        kill(vars?: {}, target?: {}): TimelineMax;
    ...
    declare class TweenLite extends GsapAnimation {
